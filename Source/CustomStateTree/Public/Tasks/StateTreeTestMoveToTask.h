...
#include "StateTreeTestMoveToTask.generated.h"
...
USTRUCT()
struct FStateTreeTestMoveToTaskInstanceData
{
	GENERATED_BODY()
...
*/
USTRUCT(meta = (DisplayName = "Test Move To", Category = "Custom|Test|AI|Action"))
struct FStateTreeTestMoveToTask : public FStateTreeAIActionTaskBase
{
	GENERATED_BODY()

	using FInstanceDataType = FStateTreeTestMoveToTaskInstanceData;

	virtual const UStruct* GetInstanceDataType() const override { return FInstanceDataType::StaticStruct(); }

	CUSTOMSTATETREE_API virtual EStateTreeRunStatus EnterState(FStateTreeExecutionContext& Context, const FStateTreeTransitionResult& Transition) const override;
	CUSTOMSTATETREE_API virtual EStateTreeRunStatus Tick(FStateTreeExecutionContext& Context, const float DeltaTime) const override;
	CUSTOMSTATETREE_API virtual void ExitState(FStateTreeExecutionContext& Context, const FStateTreeTransitionResult& Transition) const override;

	CUSTOMSTATETREE_API virtual UAITask_MoveTo* PrepareMoveToTask(FStateTreeExecutionContext& Context, AAIController& Controller, UAITask_MoveTo* ExistingTask, FAIMoveRequest& MoveRequest) const;
	CUSTOMSTATETREE_API virtual EStateTreeRunStatus PerformMoveTask(FStateTreeExecutionContext& Context, AAIController& Controller) const;
